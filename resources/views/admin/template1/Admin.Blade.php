...
<head>
  ...
  <link rel="stylesheet" href="asset/AdminLTE-2.4.4/dist/css/skins/skin-blue.min.css">
...
<div class="wrapper">
  ...
  <!-- Main Header -->
  @include('admin/template1/header')

  <!-- Left side column. contains the logo and sidebar -->
  @include('admin/template1/Body')

  <!-- Main Footer -->
  @include('admin/template1/Footer')
